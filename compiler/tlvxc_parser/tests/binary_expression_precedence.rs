use tlvxc_ast::ast::{BinaryOperator, ExpressionNode, LiteralNode, Spanned};
use tlvxc_parser::parser::expressions::parse_expression;

// Helper to unwrap Spanned types for testing
fn unwrap_spanned<T>(spanned: &Spanned<T>) -> &T {
    &spanned.node
}
use tlvxc_parser::parser::test_utils::tokenize;
